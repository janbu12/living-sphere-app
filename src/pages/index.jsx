...
function Index() {
    ...
    <div className="absolute left-0 top-1/2 transform -translate-y-1/2 px-8 text-white">
        <h1 className="text-3xl font-bold uppercase tracking-wide text-white font-[Poppins]">Selamat datang di Living Sphere</h1>
        ...
        <button className="bg-white text-black py-4 px-8 rounded-lg shadow-md hover:bg-gray-800 hover:text-white transition duration-300 text-2xl mt-4" onClick={goToQuestion1}>Mulai Kuesioner</button>
